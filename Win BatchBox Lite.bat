...
if /i "%command%"=="help" (
	echo ================================
	echo       Win BatchBox Lite Help
	echo ================================
	echo All built-in commands of Win BatchBox Lite
	...
	echo - Clean_tmp: Clear temp
	echo - Pctest: perfomance test
	echo - Exp_rest: restart explorer
	echo - Copytext: just fun command
	echo - Start_sdeb: enable Start-Up debug. This is only for developers. Last session will be erased
...
if /i "%command%"=="ver" (
	echo =========Win BatchBox Lite v1.0.8.4=======
...
if /i "%command%"=="whatnew" (
	...
	echo   z - Release
	echo   a - Patch
	echo - 3. New feature - Force debug
	echo - 4. New command - fbsod, pctest, temp, clean_tmp, ls, clear, end, powershell, cmd, suspend, exp_rest, copytext, start_sdeb
	echo Good luck using Win BatchBox Lite 1.0.8.4!
	echo.
	goto shell
)
%command%
